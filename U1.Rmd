...
Pueden considerarse como la evolución de la bombilla eléctrica, ya que se basa en el mismo principio: un filamento de tunsgteno (también conocido como wolframio) dentro de un gas inerte y un poco de halógeno (cloro, bromo, yodo, flúor, etc)
...
Las lámparas fluorescentes funcionan diferente. Están compuestas de un tubo de vidrio revestido interiormente por materiales conocidos como _fósforos_, los cuales son compuestos. ya sea de _metales de transición_ o de los elementos conocidos como _tierras raras_.
